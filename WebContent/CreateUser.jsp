	...
	$('#CreateUserTableContainer').jtable({
		...
		fields : {
			...
			userType : {
				title : 'User Type',
				width : '8%',
				options: {'System Admin':'System Admin', 'Production':'Production Module','Manpower':'Manpower Utilization','Worker':'Worker','testingClearance':'Testing Clearance','Management':'Higher Management', 'maintenance':'Plant Maintenance','All':'Super User'},
				edit : true
			},
			userName : {
				title : 'User Name',
		...
		formCreated: function (event, data) {
			...
			selectValues = { "SheetMetal": "Sheet Metal", "Wheel": "Wheelset", "Bogie": "Bogie", "Shell": "Shell" , "Paint": "Paint" ,
					"Furnishing": "Furnishing", "Electrical": "Electrical", "Testing": "Testing", "CoachManufactured": "Coach Manufactured", 
