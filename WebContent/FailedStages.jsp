...
//HttpSession session_http = ServletActionContext.getRequest().getSession(true);
 session1 = HibernateConfig.getSession();
	...
	String hql="SELECT  B.shell_no, C.furnishing_no, C.coach_type, K.remark, K.notification_stage,J.substage_description "+
					"from furnishing_tran A,shell_tran B,paint_tran C,furnishing_stage_master J,testing_mobile_clearance K "+
					"where A.shell_asset_id  = B.shell_asset_id and B.shell_asset_id= C.shell_asset_id and C.coach_type=J.coach_type and J.substage_id=K.substage_id and A.furnishing_asset_id=K.furnishing_asset_id  and A.assembly_dispatch_date is null and (K.testing_status ='failed' or K.testing_status IS NULL)"+
...
for(Object[] i: failedCoaches)
{
	...
	String notification=i[4].toString();
	String description=i[5].toString();
...
%>
		...
		<td width="10%"><label > <%=notification %></label></td>
