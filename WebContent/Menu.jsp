...
<li class="root">
 	...
 	<span class="glyphicon glyphicon-dashboard"></span></a>
        <ul class="dropdown-menu">
        	...
        	<li><s:a href="" target= "_blank">Coach2</s:a></li>
			...
			<li><s:a href="dashboard-shop-production?shop=Shell&stage=shell07">Shell Shop Production</s:a></li>
			<li><s:a href="dashboard-shop?shop=Paint&stage=paint02" target= "_blank">Paint</s:a></li>
			<li><s:a href="dashboard-shop?shop=Furnishing&stage=furn11" target= "_blank">Furnishing</s:a></li>
...
<%--  		     <li><s:a href="gant-chart-wheel-display">Wheel shop Gantt Chart</s:a></li> --%>
...
<%--  		    			<li><a href="listoffurnishing?dispatch_to=RSP">List of Shell dispatch from Furnishing</a></li>
 ...
 --%> 		  		   	<li><s:a href="coach-prod-status">Coach Production Status Report</s:a></li>
 	...
 	<li class="dropdown-submenu">
 		<a tabindex="-1" href="#">Coach Production
 		<span class="glyphicon glyphicon-shopping-cart"></span></a> 
 		<ul class="dropdown-menu"> 
 		<li><s:a href="yearwise-RSP">Year wise RSP Report</s:a></li>
 		       <li><s:a href="monthly-yearwise">monthly yearwise Report</s:a></li>
...
<!--  	<li class="dropdown-submenu"> 
 	...
 	<a tabindex="-1" href="#">..... Shop 
 		<span class="glyphicon glyphicon-shopping-cart"></span></a>
 		<ul class="dropdown-menu">
 		<%-- 	<li><s:a href="furnishing-receipt-at-testing">Receipt Semi-finished Coach</s:a></li>  
 	 <li><s:a href="coach-available-at-testing?stageId=7">Available Semi-finished Coach</s:a></li>
 	 <li><s:a href="testing-shop-production?stageId=7">Testing Shop Production</s:a></li>  --%>
...
<a href="#" class="dropdown-toggle"   data-toggle="dropdown">Maintenance<span class="glyphicon glyphicon-object-align-bottom" ></span></a>
	 	 <ul class="dropdown-menu"> 
 	 	 <li class="dropdown-submenu">
 	 	 <a tabindex="-1" href="#">Master<span class="glyphicon glyphicon-shopping-cart"></span></a>
 	 	 <ul class="dropdown-menu">
 	 	  <li><s:a href="add-machine-master">Add Machine Master</s:a></li>
 	 	   <li><s:a href="machine-schedule-activity">Add Schedule Activity</s:a></li>
 	 	  <li><s:a href="add-amc-agency-master">AMC Agency Master</s:a></li>
 	 	   <li><s:a href="machine-FIR-master">Add Machine FIR Description</s:a></li>
 	 	   <li><s:a href="safety-instruction-master">Add Safety Instructions</s:a></li>
 	 	   <li><s:a href="machine-list">Machine Safety Instruction List</s:a></li>
 	 	   <li><s:a href="link-spare-master-by-machine">Link Spare Master By Machine</s:a></li>
 	 	    <%--  <li><s:a href="machine-spare-master">Add Machine Spares</s:a></li> --%>
 	 	    <li><s:a href="spare-master">Add Spares</s:a></li> 
 	 	     <li><s:a href="user-manual-machine-maintenance">User Manual</s:a></li>
 	 	    
 	 	 </ul>
 	 	 </li>
 	 	 <li class="dropdown-submenu">
 	 	 <a tabindex="-1" href="#">Operations on Machine Maintenance<span class="glyphicon glyphicon-shopping-cart"></span></a>
 	 	 <ul class="dropdown-menu">
 	 	   <li><s:a href="machine-schedule-add">Link Schedule</s:a></li>
 			 <li><s:a href="machine-schedule-activity-add">Link Schedule Activity</s:a></li>
      ...
      <li><s:a href="failed-machine-release">Release Failed Machine</s:a></li>
        <li><s:a href="machine-schedule-failed-action">Perform Action on Failed Machine</s:a></li>
 	 	 <%--   <li><s:a href="perform-action-machine">Perform Action on Machine</s:a></li> --%>
 	 	    
 	 	  <%--  <li><s:a href="failed-machine-release">Release Failed Machine</s:a></li>  --%> 
 	 	    <li><s:a href="overdue-schedule">Overdue Schedule</s:a></li>
 	 	    <li><s:a href="overdue-perform-action">Perform Action on Overdue Schedule</s:a></li>
 	 	    <li><s:a href="overdue-target-schedule">Overdue Action Schedule</s:a></li> 
...
<li class="dropdown-submenu">
	...
	<ul class="dropdown-menu">	
 	 ...
 	 <li class="dropdown-submenu">
 		<a  tabindex="-1" href="#">Shift Allotment
 		<span class="glyphicon glyphicon-shopping-cart"></span></a>
 		<ul class="dropdown-menu">	
...
<!-- End of Manpower Utilization icon -->
 	<%}
 	 ...
 	 <li class="root">
 	 	...
 	 	<span class="glyphicon glyphicon-plus"></span></a>
 	  	...
 	  	<%} %>
 	   			...
 	   			<li><s:a href="annual-target-monthly">Set Monthly Target</s:a></li>
 	   			<li><s:a href="material-shortage-form">Material Shortage</s:a></li>
 	   		<% if(roles.contains("Bogie")) { %>	 <li><s:a href="add-machine-production">Machine Utilization</s:a></li>  <%} %>
 	 		</ul>
 	</li>
 	<li class="root">
 	 	<a class="dropdown-toggle" data-toggle="dropdown" href="#">Dashboard
 	...
 	<% if(roles.contains("Finishing")||roles.equals("All"))
 	   {%>
 	 	<li><s:a href="dashboard-shop?shop=Testing&stage=test06" target= "_blank">...shop</s:a></li> 
 	<%} %>
 			<%-- 	<li><s:a href="layout-shop" target= "_self">Shop Progress</s:a></li> --%>
 				<li><s:a href="layout-shop-trial" target= "_self">Shop Progress</s:a></li>
 				<li><s:a href="layout-shop-all" target= "_self">Coach Progress Details</s:a></li>
 	...
 	%>
 	      ...
 	      <li class="dropdown-submenu">
 	        ...
 	        <ul class="dropdown-menu">
 	          <li><a href="wheel-shop-production?stageId=1">Wheel Shop Production</a></li>
 	          <li><a href="wheel-dispatch-production">Wheel Dispatch List</a></li>
 	          <li><a href="listofwheel">List of Wheel Set</a></li>
              <li><a href="listofwheelch?dispatch_to=bogie">List of Wheel Set at Bogie</a></li>
              <li><a href="listofwheelch?dispatch_to=rsp">List of Wheel Set at RSP</a></li>
 	        <li class="dropdown-submenu">
		    <a  tabindex="-2" href="#">Reports
 		<span class="glyphicon glyphicon-arrow-right"></span></a>
 		    <ul class="dropdown-menu">	
 	...
 	<li class="dropdown-submenu">
 		...
 		<span class="glyphicon glyphicon-shopping-cart"></span></a>
 			<ul class="dropdown-menu" >
 				...
 				<li><s:a href="shell-shop-production?stageId=3">Shell Shop Production</s:a></li> 
 				<li><a href="shell-dispatch-production">Shell Dispatch List</a></li>
 				<li><a href="listofshell">List of Shell</a></li>
 				<li class="dropdown-submenu">
		    		<a  tabindex="-2" href="#">Reports
 					<span class="glyphicon glyphicon-arrow-right"></span></a>
 		    		<ul class="dropdown-menu">	
...
<%--  		    			<li><a href="listoffurnishing?dispatch_to=RSP">List of Shell dispatch from Furnishing</a></li>
 		...
 		<li><s:a href="yearwise-RSP">Year wise RSP Report</s:a></li>
 		       ...
 		       <li><s:a href="despatch-summary">despatch report</s:a></li>
 		        <li><a href="daywise-total-despatch">Daywise total despatch</a></li>
 		         ...
 		         <li><a href="coach-position-yearly-summ">Coach Position Yearly Summ</a></li>
 		         <li><a href="shopwise-monthly-staff-position">Shopwise Monthly Staff Position</a></li>
 		           <li><a href="shop-production-status">Shop Produciton Status</a></li>
 ...
 if(roles.contains("Testing_1")|| roles.contains("All_1"))  
	{ 
 	%>
	<li class="dropdown-submenu">
 			<a tabindex="-1" href="#">.... Shop
 	...
 	<%}
 	if(roles.contains("CoachTurnout_1")|| roles.contains("All_1")) 
 	{%>
 	<li class="dropdown-submenu">
 		<a tabindex="-1" href="#">Coach Turn-out
 		<span class="glyphicon glyphicon-shopping-cart"></span></a>
 ...
 <li class="dropdown-submenu">
	...
	<span class="glyphicon glyphicon-shopping-cart"></span></a>
		<ul class="dropdown-menu" >
			<li><s:a href="job-allocation">Job Allocation</s:a></li>
			<li><s:a href="job-allocation-help">Job Allocation Manual</s:a></li>  
			<li><s:a href="display-employee-job">Man Power Booking List</s:a></li> 
			<li><s:a href="dashboard-manpower-bogie" target= "_blank">Bogie Manpower Utilization</s:a></li>
