...
<ul>
  ...
  <tr>
	...
	for (Object[] s: result)
	{
		...
		String testingStatus=s[9].toString();
		...
		{ %>
		<td width="20%"><input type="radio" id="status" name="status"  value="ok" checked>Completed
		<input type="radio" id="status" name="status" value="running">Running
		<input type="radio" id="status" name="status" value="failed">Failed</td>
		<%} 
		else if(testingStatus.equals("running"))
		{ %>
		<td width="20%"><input type="radio" id="status" name="status"  value="ok" >Completed
		<input type="radio" id="status" name="status" value="running" checked>Running
		<input type="radio" id="status" name="status" value="failed">Failed</td>
		<%} 
		...
		<td width="20%"><input type="radio" id="status" name="status"  value="ok" >Completed
		<input type="radio" id="status" name="status" value="running">Running
		<input type="radio" id="status" name="status" value="failed" checked>Failed</td>
		<%} 
		else 
		{ %>
		<td width="20%"><input type="radio" id="status" name="status"  value="ok" >Completed
