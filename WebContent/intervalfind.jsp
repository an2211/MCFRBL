...
<table style="width:500px;">
	...
	<tr>
	<td><input type="text" id="StartDate" class="datePicker" value="<%=startDate%>" name="qty" onfocus="this.oldvalue=this.value" onchange="retrieveURLStart(this)"></td>
	<td><input type="text" id ="EndDate" class="datePicker"   value="<%=endDate%>" name="qty" onfocus="this.oldvalue=this.value" onchange="retrieveURLEnd(this)" ></td>
	</tr>
</table>
  <br>
  <br>
  ...
  <input type="submit" id="SUBMIT" value="Back" name="Back" class="submitBtn" onclick="goBack()" style="margin-left:20px;margin-bottom:40px;" required><br>
  </div>
  <div id="target"></div> 
</body>
</html>