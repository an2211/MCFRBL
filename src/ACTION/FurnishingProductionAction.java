...
//	}
	...
	public String update() throws IOException {	
		...
		System.out.println("Old Bogie PP Id: "+old_ppBogieAssetId);
		System.out.println("Old Bogie NPP Id: "+old_nppBogieAssetId);
		 // update record
	       
			record.setBogiePpSideAssetId(bogiePpSideAssetId1);
			System.out.println("New Bogie PP Id: "+bogiePpSideAssetId1);
			record.setBogieNppSideAssetId(bogieNppSideAssetId1);
			System.out.println("New Bogie NPP Id: "+bogieNppSideAssetId1);
	       ...
	       System.out.println("Expected Exit Date: "+expectedExitDate);
...
Criteria cr3 = session.createCriteria(BogiesetTransaction.class);
		...
		System.out.println("hi npp flag");
		 }
